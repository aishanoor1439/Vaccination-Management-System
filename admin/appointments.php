...
// fetching appointments data with related information
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
                <div class="row-lg-12">
                    <h1 class="h2 m-3">Appointments</h1>
                            ...
                            if ($result && mysqli_num_rows($result) > 0) {
                                while ($row = mysqli_fetch_assoc($result)) {
                                    ...
                                    if ($row['status'] == 'pending') {
                                        echo "<a href='approve_appointment.php?id={$row['id']}' style='color: #6f42c1;'>Approve</a>";
                                    } else {
                                        echo "<a href='reject_appointment.php?id={$row['id']}' style='color: #6f42c1;'>Reject</a>";
                                    }
                                ...
                                echo "<tr><td colspan='2' style='color: #6f42c1;'>No appointments found.</td></tr>";
                            }
                            ?>
                        </tbody>
                    </table>
