  ...
  <div class="container-fluid h-custom">
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-9 col-lg-6 col-xl-5">
        <img src="./assets/images/rb_43379.png" class="img-fluid" alt="Sample image">
      </div>
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
        <form method="post">
          ...
          <div class="text-center text-lg-start mt-4 pt-2">
            <button type="submit" value="login" name="btn_login" class="btn btn-primary btn-lg" style="padding-left: 2.5rem; padding-right: 2.5rem; background-color: #6F42C1; color: white;">Login</button>
          </div>
        </form>
        ...
        if (isset($_POST['btn_login'])) {
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                echo "<script>
                    window.location.href = 'index.php'; // redirecting to admin dashboard
                </script>";
            } else {
                echo '<script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>';
                echo "<script>
