...
// Fetch hospital and city data
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    $hospital_id = intval($_GET['id']); // Sanitizing input

    $query = "SELECT tbl_child.*, tbl_city.name as city_name 
              FROM tbl_child 
              INNER JOIN tbl_city ON tbl_child.cid = tbl_city.id 
              WHERE tbl_child.id = ?";
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
          ...
          <div class="container">
            <div class="row-lg-12">
                <h1 class="h2 mb-3 p-3" style="">Child Details</h1>
                                        ...
                                        <div class="row align-items-center">
                                            <div class="col-lg-12 px-xl-10">
                                                <div class="d-lg-inline-block py-1-9 px-1-9 px-sm-6 mb-5">
                                                    ...
                                                    <span class="text-primary">Child</span>
                                                </div>
                                                <ul class="list-unstyled mb-1-9">
                                                    <li class="mb-2 mb-xl-3 display-28"><span class="display-26 text-secondary me-2 font-weight-600">Gender: </span><?php echo htmlspecialchars($row['gender']); ?></li>
                                                    <li class="mb-2 mb-xl-3 display-28"><span class="display-26 text-secondary me-2 font-weight-600">Age: </span><?php echo htmlspecialchars($row['age']); ?></li>
