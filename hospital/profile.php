...
$hospital_id = intval($_SESSION['hospital_session']);
...
if ($result && mysqli_num_rows($result) > 0) {
    ...
    echo "<script>alert('Hospital details not found! Please log in again.'); window.location.href = 'login.php';</script>";
    exit;
}
?>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div class="container">
                <div class="row-lg-12">
                    <h1 class="h2 mb-3 mt-3">Profile</h1>
                    <form method="post">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select" aria-label="City select" name="city" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="password" class="form-control" id="password" name="password" required value="<?php echo htmlspecialchars($row['password']); ?>">
                        </div>
                        <div class="mb-3 form-check">
                            <input type="checkbox" class="form-check-input" id="exampleCheck1" name="status" <?php echo ($row['status'] == 'activated') ? 'checked' : ''; ?> disabled>
                            <label class="form-check-label" for="exampleCheck1">Activated</label>
                        </div>
                        <button type="submit" class="btn" name="btn_update" style="background-color:#6f42c1; color:white;";>Update</button>
                    </form>
                    ...
                    if (isset($_POST['btn_update'])) {
                        ...
                        $status = isset($_POST['status']) ? "activated" : "deactivated";
