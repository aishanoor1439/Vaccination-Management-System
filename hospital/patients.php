...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div class="container">
            <div class="row-lg-12">
                 <h1 class="h2 mb-3 p-3" style="">Children</h1>
                 
                 <a href="add_patient.php">Add new Child</a>
                     ...
                     if ($result && mysqli_num_rows($result) > 0) {
                         foreach ($result as $row) { 
                             echo "<tr>
                                     ...
                                     <td>
                                         <a href='patient_details.php?id={$row['patient_id']}'>View Details|</a>
                                         <a href='edit_patient.php?id={$row['patient_id']}'>Edit Details|</a>
                              ";
