...
<body id="page-top">
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div class="container">
                <h1 class="h2 mb-3 mt-3">Add Patient</h1>
                <form method="post">
    <div class="mb-3">
    ...
    <button type="submit" class="btn btn-primary" name="btn_add">Add</button>
                ...
                if (isset($_POST['btn_add'])) {
                    ...
                    $query = "INSERT INTO tbl_child(name, age, gender, cid, address, contact, email, password, status) 
                              VALUES('$name', '$age', '$gender', '$city', '$address', '$contact_no', '$email', '$password', 'Active')";
